package j2se.jfreechart.linechart;
...
public class LineChart1 extends ApplicationFrame {
	...
	private XYDataset createDataset() {
		...
		String fileName = getClass().getClassLoader().getResource("path.txt")
				.getFile();
		try {
			...
			while ((line = br.readLine()) != null) {
				...
				series1.add(Double.parseDouble(arr[0]),
